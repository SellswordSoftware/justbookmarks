...
/**
 * Sync the full tree state from the backend. Used after mutations and full reloads.
...
/**
 * Refresh only the search index from the backend without reloading the tree.
 * @returns {Promise<void>}
 */
